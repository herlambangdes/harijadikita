...
export default function LokasiPernikahan({firstPage, addResepsi}) {
   ...
   <div className={styles.container}>
    ...
    <div className={styles.form}>
        ...
        <p className={styles.descriptionOne}>Masukkan lokasi akad dan resepsi pernikahan kamu.</p>
        <p className={styles.descriptionTwo}>*Lokasi terhubung dengan Google Maps, jika lokasi tidak ditemukan, kamu bisa masukkan lintang dan bujur: <a className={styles.tutorial} href="#">lihat caranya</a></p>
